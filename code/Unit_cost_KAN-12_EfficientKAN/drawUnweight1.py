...
dataset = [
           #['Sanremo2016_final_multiplex', 56562, 'Sanremo2016',0.01, 12,'B'],
           ['celegans_connectome_multiplex', 279, 'Celegan', 0.3, 23,'A'],
           ['fao_trade_multiplex', 214, 'FaoTrade', 0.45, 324,'B'],
           ['fb-tw', 1043, 'FB-TW', 0.8, 12, 'C'],
           #['homo_genetic_multiplex', 18222, 'Homo', 0.08, 12,'A'],
           ]
for datas in dataset:
    ...
    file_paths = [
        ...
        f"results_real_kagat/StepRatio_0.0000/NormalizedLMCC_{datas[0]}.txt",
    ]
        #f"../../data/AUDC/AUDC_data/MultiDismantler/g0.5/StepRatio_0.0000/MaxCCList_Strategy_{datas[0]}.txt",
    ...
    labels = ["HDA", "CI", "MinSum", "FINDER", "NIRM", "MultiDismantler", "Vectorized Scale-Aware ChebyKAN"]
    colors = ['#a6cee3', '#b2df8a', '#fb9a99', '#fdbf6f', '#cab2d6', 'b',  'r']
    marker = ['o', 's', '^', 'D', '+', '*', 'x']
